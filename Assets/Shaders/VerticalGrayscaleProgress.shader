Shader "UI/VerticalGrayscaleProgress"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                half4 grayColor = half4(lum, lum, lum, color.a);
                
                float blendFactor = step(i.texcoord.y, _Progress);
                color = lerp(grayColor, color, blendFactor);
